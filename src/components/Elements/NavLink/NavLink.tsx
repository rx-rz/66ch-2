...
const variants = {
  main: "lg:text-3xl text-2xl md:text-3xl text-tertiary  h-full grid f font-medium  content-center transition-colors duration-300 font-pilcrow hover:text-secondary",
  primary:
