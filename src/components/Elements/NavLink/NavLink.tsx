...
const variants = {
  ...
  primary:
    "text-md text-tertiary mx-3  h-full grid font-medium  content-center lg:px-2 dark:text-white active:border-b-2 active:border-b-black dark:active:border-b-white ",
