const variants = {
  ...
  authPrimary:
    "text-xl font-pilcrow lg:w-5/12 w-full bg-secondary text-black p-3  transition-shadow duration-300 border-tertiary border hover:shadow-2xl shadow-black mb-8 md:mb-0",
  pendingButton:
