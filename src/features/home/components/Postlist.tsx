...
export default function Postlist() {
  ...
  /* Create a variable 'middle' that selects a random element from the 'posts' 
  array using the Math.floor and Math.random functions, if posts is not null or 
  undefined */

  const postsTwo = posts && posts.slice(7);
  /* Create a variable 'postsTwo' by slicing the elements starting 
  from index 7 of the 'posts' array, if posts is not null or undefined */
