...
export default function ProfileBanner() {
  ...
  return (
    <div className="w-11/12 mx-auto md:flex block my-16">
      {user && (
        <>
          <img className="md:w-4/12 w-full border border-black" src={user.photoURL!} alt={user.displayName!} />
          <aside className="md:ml-8 md:w-8/12 w-/12 mt-6 md:mt-0">
            <h1 className="text-4xl md:text-6xl font-medium font-Amulya mb-4 text-tertiary">{user.displayName}</h1>
