      ...
      {({ register, formState }) => (
        <>
          <TextAreaField
            ...
            className="border-2 border-black dark:border-white w-full  resize-none p-2 text-black"
          />
          <button
            type="submit"
            className="border-2 px-3 border-black dark:border-white font-pilcrow bg-secondary dark:text-white"
          >
            Comment
          </button>
        </>
